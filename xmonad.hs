...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), spawn "chromium-browser")
    ...
    , ((modm .|. mod1Mask , xK_g), spawn "chromium-browser --app=https://app.groupme.com")
...
main = do
  -- ADDED: Runs xmobar
  xmproc <- spawnPipe "xmobar /home/jarrod/.xmonad/xmobar.hs"
...
-- NO LONGER USED (ADDED TO MAIN DO LOOP TO ALLOW DYNAMIC XMOBAR WORKSPACE INDICATORS)
